...
class IntPreferencesEntry extends SharedPreferencesEntry<int> {
  ...
  @override
  Future<int?> read() async => sharedPreferences.getInt(key);

  @override
  Future<void> set(int value) async => await sharedPreferences.setInt(key, value);

  @override
  Future<void> remove() async => await sharedPreferences.remove(key);
}
...
class StringPreferencesEntry extends SharedPreferencesEntry<String> {
  ...
  @override
  Future<String?> read() async => sharedPreferences.getString(key);

  @override
  Future<void> set(String value) async => await sharedPreferences.setString(key, value);
...
class BoolPreferencesEntry extends SharedPreferencesEntry<bool> {
  ...
  @override
  Future<bool?> read() async => sharedPreferences.getBool(key);

  @override
  Future<void> set(bool value) async => await sharedPreferences.setBool(key, value);
...
class DoublePreferencesEntry extends SharedPreferencesEntry<double> {
  ...
  @override
  Future<double?> read() async => sharedPreferences.getDouble(key);

  @override
  Future<void> set(double value) async => await sharedPreferences.setDouble(key, value);
...
class StringListPreferencesEntry extends SharedPreferencesEntry<List<String>> {
  ...
  @override
  Future<List<String>?> read() async => sharedPreferences.getStringList(key);

  @override
  Future<void> set(List<String> value) async => await sharedPreferences.setStringList(key, value);
