...
/// {@endtemplate}
@immutable
abstract base class BaseClientException implements Exception {
  /// {@macro network_exception}
  const BaseClientException({
...
///
/// [response] is a map that contains the error details
///
...
/// exceptions.
/// {@endtemplate}
final class StructuredBackendException extends BaseClientException {
  ...
  String get error => response['error'] as String? ?? 'none-detailed';
}
...
/// {@endtemplate}
final class WrongResponseTypeException extends BaseClientException {
...
/// {@endtemplate}
final class ConnectionException extends BaseClientException {
...
/// {@endtemplate}
final class InternalServerException extends BaseClientException {
...
/// {@template resource_not_found_exception}
/// [ResourceNotFoundException] is thrown if the requested resource was not found
/// on the server side. 404 HTTP status code is expected.
/// {@endtemplate}
final class ResourceNotFoundException extends BaseClientException {
  /// {@macro resource_not_found_exception}
